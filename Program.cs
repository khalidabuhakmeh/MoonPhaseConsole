...
namespace MoonPhaseConsole
{
    class Program
    {
        ...
        public static class Moon
        {
            ...
            /// <returns></returns>
            public static PhaseResult Calculate(DateTime utcDateTime, Earth.Hemispheres viewFromEarth = Earth.Hemispheres.Northern)
            {
                ...
                var daysSinceLastNewMoon = new DateTime(1920, 1, 21, 5, 25, 00, DateTimeKind.Utc).ToOADate() + julianConstant;
            ...
            {
                public PhaseResult(string name, string emoji, double daysIntoCycle, Earth.Hemispheres hemisphere, DateTime date)
                {
                    Name = name;
                    Emoji = emoji;
